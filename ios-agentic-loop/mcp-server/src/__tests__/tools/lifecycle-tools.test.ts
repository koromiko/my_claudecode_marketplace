...
const ctx: ServerContext = {
  config: {
    ...
    app: { bundle_id: "com.test.app", extension_bundle_ids: [], build_command: "xcodebuild -scheme Test build", app_group: "" },
...
describe("lifecycle tools registration", () => {
  it("registers 4 tools on the server", () => {
